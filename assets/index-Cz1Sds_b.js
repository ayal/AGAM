...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function Sh(){return new on({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function yh(){return new on({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
	...
	`}class _c extends qn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},s=[i,i,i,i,i,i];this.texture=new bu(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new gs(5,5,5),r=new on({name:"CubemapFromEquirect",uniforms:tr(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:gn,blending:bi});r.uniforms.tEquirect.value=e;const a=new Pe(s,r),o=e.minFilter;return e.minFilter===ki&&(e.minFilter=Ke),new Pu(1,10,this).update(t,a),e.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(t,e=!0,i=!0,s=!0){const r=t.getRenderTarget();for(let a=0;a<6;a++)t.setRenderTarget(this,a),t.clear(e,i,s);t.setRenderTarget(r)}}function I0(n){let t=new WeakMap,e=new WeakMap,i=null;function s(d,f=!1){return d==null?null:f?a(d):r(d)}function r(d){if(d&&d.isTexture){const f=d.mapping;if(f===oo||f===lo)if(t.has(d)){const g=t.get(d).texture;return o(g,d.mapping)}else{const g=d.image;if(g&&g.height>0){const S=new _c(g.height);return S.fromEquirectangularTexture(n,d),t.set(d,S),d.addEventListener("dispose",c),o(S.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){const f=d.mapping,g=f===oo||f===lo,S=f===ds||f===Ks;if(g||S){let m=e.get(d);const p=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==p)return i===null&&(i=new vh(n)),m=g?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,e.set(d,m),m.texture;if(m!==void 0)return m.texture;{const M=d.image;return g&&M&&M.height>0||S&&M&&l(M)?(i===null&&(i=new vh(n)),m=g?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,e.set(d,m),d.addEventListener("dispose",h),m.texture):null}}}return d}function o(d,f){return f===oo?d.mapping=ds:f===lo&&(d.mapping=Ks),d}function l(d){let f=0;const g=6;for(let S=0;S<g;S++)d[S]!==void 0&&f++;return f===g}function c(d){const f=d.target;f.removeEventListener("dispose",c);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function h(d){const f=d.target;f.removeEventListener("dispose",h);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(){t=new WeakMap,e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:u}}function U0(n){const t={};function e(i){if(t[i]!==void 0)return t[i];const s=n.getExtension(i);return t[i]=s,s}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const s=e(i);return s===null&&Bl("WebGLRenderer: "+i+" extension not supported."),s}}}function N0(n,t,e,i){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const f in d)t.update(d[f],n.ARRAY_BUFFER)}function c(u){const d=[],f=u.index,g=u.attributes.position;let S=0;if(g===void 0)return;if(f!==null){const M=f.array;S=f.version;for(let y=0,T=M.length;y<T;y+=3){const P=M[y+0],b=M[y+1],R=M[y+2];d.push(P,b,b,R,R,P)}}else{const M=g.array;S=g.version;for(let y=0,T=M.length/3-1;y<T;y+=3){const P=y+0,b=y+1,R=y+2;d.push(P,b,b,R,R,P)}}const m=new(g.count>=65535?Mu:vu)(d,1);m.version=S;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function F0(n,t,e){let i;function s(u){i=u}let r,a;function o(u){r=u.type,a=u.bytesPerElement}function l(u,d){n.drawElements(i,d,r,u*a),e.update(d,i,1)}function c(u,d,f){f!==0&&(n.drawElementsInstanced(i,d,r,u*a,f),e.update(d,i,f))}function h(u,d,f){if(f===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,r,u,0,f);let S=0;for(let m=0;m<f;m++)S+=d[m];e.update(S,i,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function O0(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(r/3);break;case n.LINES:e.lines+=o*(r/2);break;case n.LINE_STRIP:e.lines+=o*(r-1);break;case n.LINE_LOOP:e.lines+=o*r;break;case n.POINTS:e.points+=o*r;break;default:ee("WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:i}}function B0(n,t,e){const i=new WeakMap,s=new we;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=i.get(o);if(d===void 0||d.count!==u){let D=function(){x.dispose(),i.delete(o),o.removeEventListener("dispose",D)};var f=D;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],M=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let T=0;g===!0&&(T=1),S===!0&&(T=2),m===!0&&(T=3);let P=o.attributes.position.count*T,b=1;P>t.maxTextureSize&&(b=Math.ceil(P/t.maxTextureSize),P=t.maxTextureSize);const R=new Float32Array(P*b*4*u),x=new gu(R,P,b,u);x.type=ni,x.needsUpdate=!0;const A=T*4;for(let w=0;w<u;w++){const C=p[w],V=M[w],X=y[w],U=P*b*4*w;for(let H=0;H<C.count;H++){const B=H*A;g===!0&&(s.fromBufferAttribute(C,H),R[U+B+0]=s.x,R[U+B+1]=s.y,R[U+B+2]=s.z,R[U+B+3]=0),S===!0&&(s.fromBufferAttribute(V,H),R[U+B+4]=s.x,R[U+B+5]=s.y,R[U+B+6]=s.z,R[U+B+7]=0),m===!0&&(s.fromBufferAttribute(X,H),R[U+B+8]=s.x,R[U+B+9]=s.y,R[U+B+10]=s.z,R[U+B+11]=X.itemSize===4?s.w:1)}}d={count:u,texture:x,size:new wt(P,b)},i.set(o,d),o.addEventListener("dispose",D)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const S=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(n,"morphTargetBaseInfluence",S),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function z0(n,t,e,i,s){let r=new WeakMap;function a(c){const h=s.render.frame,u=c.geometry,d=t.get(c,u);if(r.get(d)!==h&&(t.update(d),r.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==h&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,h))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==h&&(f.update(),r.set(f,h))}return d}function o(){r=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),i.releaseStatesOfObject(h),e.remove(h.instanceMatrix),h.instanceColor!==null&&e.remove(h.instanceColor)}return{update:a,dispose:o}}const k0={[tu]:"LINEAR_TONE_MAPPING",[eu]:"REINHARD_TONE_MAPPING",[nu]:"CINEON_TONE_MAPPING",[iu]:"ACES_FILMIC_TONE_MAPPING",[ru]:"AGX_TONE_MAPPING",[au]:"NEUTRAL_TONE_MAPPING",[su]:"CUSTOM_TONE_MAPPING"};function G0(n,t,e,i,s){const r=new qn(t,e,{type:n,depthBuffer:i,stencilBuffer:s,depthTexture:i?new Js(t,e):void 0}),a=new qn(t,e,{type:ai,depthBuffer:!1,stencilBuffer:!1}),o=new ze;o.setAttribute("position",new Se([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Se([0,2,0,0,2,0],2));const l=new Af({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Pe(o,l),h=new gc(-1,1,1,-1,0,1);let u=null,d=null,f=!1,g,S=null,m=[],p=!1;this.setSize=function(M,y){r.setSize(M,y),a.setSize(M,y);for(let T=0;T<m.length;T++){const P=m[T];P.setSize&&P.setSize(M,y)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;const y=r.width,T=r.height;for(let P=0;P<m.length;P++){const b=m[P];b.setSize&&b.setSize(y,T)}},this.begin=function(M,y){if(f||M.toneMapping===si&&m.length===0)return!1;if(S=y,y!==null){const T=y.width,P=y.height;(r.width!==T||r.height!==P)&&this.setSize(T,P)}return p===!1&&M.setRenderTarget(r),g=M.toneMapping,M.toneMapping=si,!0},this.hasRenderPass=function(){return p},this.end=function(M,y){M.toneMapping=g,f=!0;let T=r,P=a;for(let b=0;b<m.length;b++){const R=m[b];if(R.enabled!==!1&&(R.render(M,P,T,y),R.needsSwap!==!1)){const x=T;T=P,P=x}}if(u!==M.outputColorSpace||d!==M.toneMapping){u=M.outputColorSpace,d=M.toneMapping,l.defines={},te.getTransfer(u)===fe&&(l.defines.SRGB_TRANSFER="");const b=k0[d];b&&(l.defines[b]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=T.texture,M.setRenderTarget(S),M.render(c,h),S=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.depthTexture&&r.depthTexture.dispose(),r.dispose(),a.dispose(),o.dispose(),l.dispose()}}const Uu=new Qe,Gl=new Js(1,1),Nu=new gu,Fu=new nf,Ou=new bu,bh=[],Eh=[],Th=new Float32Array(16),wh=new Float32Array(9),Ah=new Float32Array(4);function nr(n,t,e){const i=n[0];if(i<=0||i>0)return n;const s=t*e;let r=bh[s];if(r===void 0&&(r=new Float32Array(s),bh[s]=r),t!==0){i.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,n[a].toArray(r,o)}return r}function Ye(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function qe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Qa(n,t){let e=Eh[t];e===void 0&&(e=new Int32Array(t),Eh[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function H0(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function V0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ye(e,t))return;n.uniform2fv(this.addr,t),qe(e,t)}}function W0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ye(e,t))return;n.uniform3fv(this.addr,t),qe(e,t)}}function X0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ye(e,t))return;n.uniform4fv(this.addr,t),qe(e,t)}}function Y0(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Ye(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),qe(e,t)}else{if(Ye(e,i))return;Ah.set(i),n.uniformMatrix2fv(this.addr,!1,Ah),qe(e,i)}}function q0(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Ye(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),qe(e,t)}else{if(Ye(e,i))return;wh.set(i),n.uniformMatrix3fv(this.addr,!1,wh),qe(e,i)}}function j0(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Ye(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),qe(e,t)}else{if(Ye(e,i))return;Th.set(i),n.uniformMatrix4fv(this.addr,!1,Th),qe(e,i)}}function Z0(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function $0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ye(e,t))return;n.uniform2iv(this.addr,t),qe(e,t)}}function K0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ye(e,t))return;n.uniform3iv(this.addr,t),qe(e,t)}}function J0(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ye(e,t))return;n.uniform4iv(this.addr,t),qe(e,t)}}function Q0(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function tg(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ye(e,t))return;n.uniform2uiv(this.addr,t),qe(e,t)}}function eg(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ye(e,t))return;n.uniform3uiv(this.addr,t),qe(e,t)}}function ng(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ye(e,t))return;n.uniform4uiv(this.addr,t),qe(e,t)}}function ig(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(Gl.compareFunction=e.isReversedDepthBuffer()?ac:rc,r=Gl):r=Uu,e.setTexture2D(t||r,s)}function sg(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture3D(t||Fu,s)}function rg(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTextureCube(t||Ou,s)}function ag(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture2DArray(t||Nu,s)}function og(n){switch(n){case 5126:return H0;case 35664:return V0;case 35665:return W0;case 35666:return X0;case 35674:return Y0;case 35675:return q0;case 35676:return j0;case 5124:case 35670:return Z0;case 35667:case 35671:return $0;case 35668:case 35672:return K0;case 35669:case 35673:return J0;case 5125:return Q0;case 36294:return tg;case 36295:return eg;case 36296:return ng;case 35678:case 36198:case 36298:case 36306:case 35682:return ig;case 35679:case 36299:case 36307:return sg;case 35680:case 36300:case 36308:case 36293:return rg;case 36289:case 36303:case 36311:case 36292:return ag}}function lg(n,t){n.uniform1fv(this.addr,t)}function cg(n,t){const e=nr(t,this.size,2);n.uniform2fv(this.addr,e)}function hg(n,t){const e=nr(t,this.size,3);n.uniform3fv(this.addr,e)}function ug(n,t){const e=nr(t,this.size,4);n.uniform4fv(this.addr,e)}function dg(n,t){const e=nr(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function fg(n,t){const e=nr(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function pg(n,t){const e=nr(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function mg(n,t){n.uniform1iv(this.addr,t)}function gg(n,t){n.uniform2iv(this.addr,t)}function _g(n,t){n.uniform3iv(this.addr,t)}function xg(n,t){n.uniform4iv(this.addr,t)}function vg(n,t){n.uniform1uiv(this.addr,t)}function Mg(n,t){n.uniform2uiv(this.addr,t)}function Sg(n,t){n.uniform3uiv(this.addr,t)}function yg(n,t){n.uniform4uiv(this.addr,t)}function bg(n,t,e){const i=this.cache,s=t.length,r=Qa(e,s);Ye(i,r)||(n.uniform1iv(this.addr,r),qe(i,r));let a;this.type===n.SAMPLER_2D_SHADOW?a=Gl:a=Uu;for(let o=0;o!==s;++o)e.setTexture2D(t[o]||a,r[o])}function Eg(n,t,e){const i=this.cache,s=t.length,r=Qa(e,s);Ye(i,r)||(n.uniform1iv(this.addr,r),qe(i,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Fu,r[a])}function Tg(n,t,e){const i=this.cache,s=t.length,r=Qa(e,s);Ye(i,r)||(n.uniform1iv(this.addr,r),qe(i,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Ou,r[a])}function wg(n,t,e){const i=this.cache,s=t.length,r=Qa(e,s);Ye(i,r)||(n.uniform1iv(this.addr,r),qe(i,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Nu,r[a])}function Ag(n){switch(n){case 5126:return lg;case 35664:return cg;case 35665:return hg;case 35666:return ug;case 35674:return dg;case 35675:return fg;case 35676:return pg;case 5124:case 35670:return mg;case 35667:case 35671:return gg;case 35668:case 35672:return _g;case 35669:case 35673:return xg;case 5125:return vg;case 36294:return Mg;case 36295:return Sg;case 36296:return yg;case 35678:case 36198:case 36298:case 36306:case 35682:return bg;case 35679:case 36299:case 36307:return Eg;case 35680:case 36300:case 36308:case 36293:return Tg;case 36289:case 36303:case 36311:case 36292:return wg}}class Rg{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=og(e.type)}}class Cg{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Ag(e.type)}}class Pg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(t,e[o.id],i)}}}const ko=/(\w+)(\])?(\[|\.)?/g;function Rh(n,t){n.seq.push(t),n.map[t.id]=t}function Dg(n,t,e){const i=n.name,s=i.length;for(ko.lastIndex=0;;){const r=ko.exec(i),a=ko.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Rh(e,c===void 0?new Rg(o,n,t):new Cg(o,n,t));break}else{let u=e.map[o];u===void 0&&(u=new Pg(o),Rh(e,u)),e=u}}}class Da{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=t.getActiveUniform(e,a),l=t.getUniformLocation(e,o.name);Dg(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===t.SAMPLER_2D_SHADOW||a.type===t.SAMPLER_CUBE_SHADOW||a.type===t.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(t,e,i,s){const r=this.map[e];r!==void 0&&r.setValue(t,i,s)}setOptional(t,e,i){const s=e[i];s!==void 0&&this.setValue(t,i,s)}static upload(t,e,i,s){for(let r=0,a=e.length;r!==a;++r){const o=e[r],l=i[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,s)}}static seqWithValue(t,e){const i=[];for(let s=0,r=t.length;s!==r;++s){const a=t[s];a.id in e&&i.push(a)}return i}}function Ch(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Lg=37297;let Ig=0;function Ug(n,t){const e=n.split(`
`),i=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return i.join(`
`)}const Ph=new Gt;function Ng(n){te._getMatrix(Ph,te.workingColorSpace,n);const t=`mat3( ${Ph.elements.map(e=>e.toFixed(4))} )`;switch(te.getTransfer(n)){case ka:return[t,"LinearTransferOETF"];case fe:return[t,"sRGBTransferOETF"];default:return Nt("WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function Dh(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=(n.getShaderInfoLog(t)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return e.toUpperCase()+`

`+r+`

`+Ug(n.getShaderSource(t),o)}else return r}function Fg(n,t){const e=Ng(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const Og={[tu]:"Linear",[eu]:"Reinhard",[nu]:"Cineon",[iu]:"ACESFilmic",[ru]:"AgX",[au]:"Neutral",[su]:"Custom"};function Bg(n,t){const e=Og[t];return e===void 0?(Nt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const _a=new L;function zg(){te.getLuminanceCoefficients(_a);const n=_a.x.toFixed(4),t=_a.y.toFixed(4),e=_a.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Hg(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(t,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function Ar(n){return n!==""}function Lh(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ih(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Vg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Hl(n){return n.replace(Vg,Xg)}const Wg=new Map;function Xg(n,t){let e=Xt[t];if(e===void 0){const i=Wg.get(t);if(i!==void 0)e=Xt[i],Nt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return Hl(e)}const Yg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Uh(n){return n.replace(Yg,qg)}function qg(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Nh(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}const jg={[Ta]:"SHADOWMAP_TYPE_PCF",[wr]:"SHADOWMAP_TYPE_VSM"};function Zg(n){return jg[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const $g={[ds]:"ENVMAP_TYPE_CUBE",[Ks]:"ENVMAP_TYPE_CUBE",[Za]:"ENVMAP_TYPE_CUBE_UV"};function Kg(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":$g[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const Jg={[Ks]:"ENVMAP_MODE_REFRACTION"};function Qg(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":Jg[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const t_={[Jl]:"ENVMAP_BLENDING_MULTIPLY",[Md]:"ENVMAP_BLENDING_MIX",[Sd]:"ENVMAP_BLENDING_ADD"};function e_(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":t_[n.combine]||"ENVMAP_BLENDING_NONE"}function n_(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function i_(n,t,e,i){const s=n.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Zg(e),c=Kg(e),h=Qg(e),u=e_(e),d=n_(e),f=kg(e),g=Gg(r),S=s.createProgram();let m,p,M=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const y=M+m+a,T=M+p+o,P=Ch(s,s.VERTEX_SHADER,y),b=Ch(s,s.FRAGMENT_SHADER,T);s.attachShader(S,P),s.attachShader(S,b),e.index0AttributeName!==void 0?s.bindAttribLocation(S,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function R(w){if(n.debug.checkShaderErrors){const C=s.getProgramInfoLog(S)||"",V=s.getShaderInfoLog(P)||"",X=s.getShaderInfoLog(b)||"",U=C.trim(),H=V.trim(),B=X.trim();let Q=!0,it=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,S,P,b);else{const ut=Dh(s,P,"vertex"),vt=Dh(s,b,"fragment");ee("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
`;function Nx(n,t){n.magFilter=n.minFilter=Ke,n.wrapS=n.wrapT=ei;const e=new on({defines:{ITERATIONS:"20",OCTIVES:"3"},uniforms:{fireTex:{value:n},color:{value:new gt(15658734)},time:{value:0},seed:{value:Math.random()*19.19},invModelMatrix:{value:new Me},scale:{value:new L(1,1,1)},noiseScale:{value:new we(1,2,1,.3)},magnitude:{value:1.3},lacunarity:{value:2},gain:{value:.5},uIntensity:{value:1}},vertexShader:Ix,fragmentShader:Ux,transparent:!0,depthWrite:!1,depthTest:!0}),i=new Pe(new gs(1,1,1),e);return i.updateFire=(s,r)=>{i.updateMatrixWorld(),e.uniforms.invModelMatrix.value.copy(i.matrixWorld).invert(),e.uniforms.time.value=s,e.uniforms.scale.value=i.scale,e.uniforms.uIntensity.value=r},i}function Fx(){const t=document.createElement("canvas");t.width=t.height=64;const e=t.getContext("2d"),i=e.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return i.addColorStop(0,"rgba(255,255,255,1)"),i.addColorStop(.4,"rgba(255,255,255,0.55)"),i.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=i,e.fillRect(0,0,64,64),new Ka(t)}function Ox(){const t=document.createElement("canvas");t.width=t.height=64;const e=t.getContext("2d"),i=e.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return i.addColorStop(0,"rgba(255,255,255,1)"),i.addColorStop(.55,"rgba(255,255,255,0.95)"),i.addColorStop(.78,"rgba(255,255,255,0.3)"),i.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=i,e.fillRect(0,0,64,64),new Ka(t)}function qo(n){return new on({uniforms:{uMap:{value:n},uOpacity:{value:1},uScale:{value:800},uTint:{value:new gt(1,1,1)}},transparent:!0,depthWrite:!1,vertexShader:`
...
#include <opaque_fragment>`)}},ju=(n,t)=>{const e=new Hr(n,64,44),i=e.attributes.position,s=new Float32Array(i.count*3),r=new L,a=new gt;for(let l=0;l<i.count;l++){r.fromBufferAttribute(i,l);const c=t(r,a);if(c){const h=(n+c)/n;i.setXYZ(l,r.x*h,r.y*h,r.z*h)}s[l*3]=a.r,s[l*3+1]=a.g,s[l*3+2]=a.b}e.setAttribute("color",new Te(s,3)),e.computeVertexNormals();const o=new Or({vertexColors:!0});return zx(o,.45),new Pe(e,o)};function kx(n){const t=ju(25,(e,i)=>{const s=n.fbm(e.x*.14,e.y*.14,e.z*.14),r=Math.min(1,Math.max(.55,.78+.5*(s-.5)));return i.setRGB(Math.pow(r,.4),.99*Math.pow(r,.8),.84*Math.pow(r,1.6)),0});{const i=document.createElement("canvas");i.width=i.height=128;const s=i.getContext("2d"),r=s.createRadialGradient(128/2,128/2,128*.3,128/2,128/2,128/2);r.addColorStop(0,"rgba(255,235,160,0.32)"),r.addColorStop(1,"rgba(255,235,160,0)"),s.fillStyle=r,s.fillRect(0,0,128,128);const a=new yu(new cc({map:new Ka(i),transparent:!0,depthWrite:!1}));a.scale.set(80,80,1),t.add(a)}return t}function Gx(n){return ju(19,(t,e)=>{const i=n.fbm(t.x*.045,t.y*.045,t.z*.045),s=n.fbm(t.x*.3+40,t.y*.3,t.z*.3),r=Math.min(1,Math.max(.35,.88+.22*(s-.5)-.34*n.sstep(.52,.72,i)));return e.setRGB(Math.min(1,.92*r+.1),Math.min(1,.93*r+.12),Math.min(1,.96*r+.16)),(s-.5)*.9})}function Hx(n,t,e){const i=new Ws({color:16777215,vertexColors:!0,polygonOffset:!0,polygonOffsetFactor:1,polygonOffsetUnits:1,dithering:!0}),s=new Hr(t,160,112),r=s.attributes.position,a=new Float32Array(r.count*3),o=new gt(7038298),l=new gt(9078144),c=new gt(11050895),h=new gt(9078144),u=new gt;for(let f=0;f<r.count;f++){const g=r.getX(f),S=r.getY(f),m=r.getZ(f),p=n.fbm(g*.011,S*.011,m*.011),M=t*Math.acos(Math.min(1,Math.max(-1,S/t))),y=n.sstep(40,120,M),T=(p-.5)*22*y,P=(t+T)/t;r.setXYZ(f,g*P,S*P,m*P),p<.5?u.lerpColors(o,l,p*2):u.lerpColors(l,c,(p-.5)*2),u.lerp(h,1-y),a[f*3]=u.r,a[f*3+1]=u.g,a[f*3+2]=u.b}s.setAttribute("color",new Te(a,3)),s.computeVertexNormals();const d=new Pe(s,i);return d.position.y=e-t-.6,d}const Vx=`
...
`;function Wx(n,t){const e=new Au().load("cloud.png"),i=new on({uniforms:{uMap:{value:e},uScale:{value:800},uSun:{value:new L(0,1,0)},uSunCol:{value:new gt(1,1,1)},uSunI:{value:1},uCenter:{value:new L},uDay:{value:1},uDusk:{value:0},uTime:{value:0}},transparent:!0,depthWrite:!1,vertexShader:`
      attribute float aSize;
    ...
    `}),i=new Pe(new Hr(n*3.2,48,32),e);return i.renderOrder=-1,i.frustumCulled=!1,{mesh:i,uniforms:t}}class to extends Pe{constructor(t,e={}){super(t),this.isReflector=!0,this.type="Reflector",this.forceUpdate=!1,this._reflectionCameras=new WeakMap;const i=this,s=e.color!==void 0?new gt(e.color):new gt(8355711),r=e.textureWidth||512,a=e.textureHeight||512,o=e.clipBias||0,l=e.shader||to.ReflectorShader,c=e.multisample!==void 0?e.multisample:4,h=new yi,u=new L,d=new L,f=new L,g=new Me,S=new L(0,0,-1),m=new we,p=new L,M=new L,y=new we,T=new Me,P=new qn(r,a,{samples:c,type:ai}),b=new on({name:l.name!==void 0?l.name:"unspecified",uniforms:wu.clone(l.uniforms),fragmentShader:l.fragmentShader,vertexShader:l.vertexShader});b.uniforms.tDiffuse.value=P.texture,b.uniforms.color.value=s,b.uniforms.textureMatrix.value=T,this.material=b,this.onBeforeRender=function(R,x,A){const D=this._getReflectionCamera(A);if(d.setFromMatrixPosition(i.matrixWorld),f.setFromMatrixPosition(A.matrixWorld),g.extractRotation(i.matrixWorld),u.set(0,0,1),u.applyMatrix4(g),p.subVectors(d,f),p.dot(u)>0===!0&&this.forceUpdate===!1)return;p.reflect(u).negate(),p.add(d),g.extractRotation(A.matrixWorld),S.set(0,0,-1),S.applyMatrix4(g),S.add(f),M.subVectors(d,S),M.reflect(u).negate(),M.add(d),D.position.copy(p),D.up.set(0,1,0),D.up.applyMatrix4(g),D.up.reflect(u),D.lookAt(M),D.far=A.far,D.updateMatrixWorld(),D.projectionMatrix.copy(A.projectionMatrix),T.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),T.multiply(D.projectionMatrix),T.multiply(D.matrixWorldInverse),T.multiply(i.matrixWorld),h.setFromNormalAndCoplanarPoint(u,d),h.applyMatrix4(D.matrixWorldInverse),m.set(h.normal.x,h.normal.y,h.normal.z,h.constant);const C=D.projectionMatrix;D.isOrthographicCamera?(y.x=(Math.sign(m.x)+C.elements[8])/C.elements[0],y.y=(Math.sign(m.y)+C.elements[9])/C.elements[5],y.z=-A.far,y.w=1):(y.x=(Math.sign(m.x)+C.elements[8])/C.elements[0],y.y=(Math.sign(m.y)+C.elements[9])/C.elements[5],y.z=-1,y.w=(1+C.elements[10])/C.elements[14]),m.multiplyScalar(2/m.dot(y)),C.elements[2]=m.x,C.elements[6]=m.y,D.isOrthographicCamera?(C.elements[10]=m.z-o,C.elements[14]=m.w-1):(C.elements[10]=m.z+1-o,C.elements[14]=m.w),i.visible=!1;const V=R.getRenderTarget(),X=R.xr.enabled,U=R.shadowMap.autoUpdate;R.xr.enabled=!1,R.shadowMap.autoUpdate=!1,R.setRenderTarget(P),R.state.buffers.depth.setMask(!0),R.autoClear===!1&&R.clear(),R.render(x,D),R.xr.enabled=X,R.shadowMap.autoUpdate=U,R.setRenderTarget(V);const H=A.viewport;H!==void 0&&R.state.viewport(H),i.visible=!0,this.forceUpdate=!1},this.getRenderTarget=function(){return P},this.dispose=function(){P.dispose(),i.material.dispose()},this._getReflectionCamera=function(R){let x=this._reflectionCameras.get(R);return x===void 0&&(x=R.clone(),this._reflectionCameras.set(R,x)),x}}}to.ReflectorShader={name:"ReflectorShader",uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null}},vertexShader:`
		...
		}`};function Yx(n,t,e){const i=new _c(512),s=new Pu(.5,2e3,i);s.position.y=t+.5;const r=[],a=new on({uniforms:{uTime:{value:0},envMap:{value:i.texture}},side:mn,vertexShader:`
      varying vec2 vUv;
      varying vec3 vWorldPos;
    ...
    `}),o=new dc(n,96);let l;if(e){const h={uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null},uTime:{value:0},uImpactR:{value:new L(.5,.55,.6)},uImpactA:{value:new L(0,0,0)},uNight:{value:0},uSky:{value:new gt(13422288)}},vertexShader:`
        uniform mat4 textureMatrix;
      ...
      `};l=new to(o,{textureWidth:1024,textureHeight:1024,clipBias:.003,shader:h})}else l=new Pe(o,a);l.rotation.x=-Math.PI/2,l.position.y=t,r.push(l);const c=new Gi;{const u=t+.6,d=t-2.6,f=new Ws({color:10130570,side:mn,dithering:!0}),g=new Pe(new Qs(n+1.7,n+1.7,u-d,96,1,!0),f);g.position.y=(u+d)/2;const S=new Pe(new Qs(n,n,u-(t-1),96,1,!0),f);S.position.y=(u+t-1)/2;const m=new Pe(new fc(n,n+1.7,96),f);m.rotation.x=-Math.PI/2,m.position.y=u,c.add(g,S,m)}return{pool:l,crisp:e,cubeCam:s,cubeRT:i,waterMeshes:r,basin:c}}const Wh=.035,Ec=()=>({crisp:!0});function qx(n=Ec(),t=!1){const e=new Gi,i=[7,12,16,10.5,6.5],s=[3,3.6,6.5,4,3],r=i.length,a=.3,o=s.reduce((J,Jt)=>J+Jt,0)+a*(r-1),l=.9,c=2*l/Math.sin(Math.PI/3),h=t?!1:Math.random()<Wh,u=13422288,d=Math.max(...i),f=n.crisp,g=[];let S=-o/2;for(let J=0;J<r;J++)g[J]=S+s[J]/2,S+=s[J]+a;const m=-o/2-.5,p=new If(16777215,13617339,1.1),M=new fh(16773856,4.5);M.position.set(60,90,40);const y=new fh(14674175,.2);y.position.set(-50,40,-60),e.add(p,M,y);const T=27,P=620,b=32*Math.PI/180,R=Bx(),x=kx(R),A=Gx(R),D=Math.PI,w=1;e.add(x,A);const C=new L,V=Math.random(),X=4+Math.random()*1.2,U=3+Math.random()*.6,H=new gt(12113128),B=new gt(8555166),Q=new gt().lerpColors(new gt(14659722),new gt(16736304),V),it=new gt(16773856),ut=new gt(16752478),vt=new gt(16777215),At=new gt(9674944),zt=new gt(11577496),Qt=new gt(4869981),j=new gt(14674175),O=new gt(12175598),K=new gt().lerpColors(new gt(16764826),new gt(16748624),V),et=new gt(16774088),Rt=new gt(16754788),Lt=new gt;let Pt=10,xe=0,Yt=!1;const he=new gt(3043e3),_e=new gt(4937848),qt=new gt().lerpColors(new gt(7895208),new gt(6301066),V),Le=new gt,ve=Xx(P),Oe=ve.uniforms;e.add(ve.mesh);const N=320,Ue=Hx(R,N,m);e.add(Ue);const Vt=Wx(N,m);e.add(Vt.points);const de=new Ws({color:7301726,transparent:!0,opacity:.55,depthWrite:!1,side:mn,dithering:!0}),pt=g[r-1]-s[r-1]/2,Ae=pt-m,E=new Pe(new Qs(3.5,3.5,Ae,32),de);E.position.y=(pt+m)/2,e.add(E);const{pool:_,cubeCam:z,cubeRT:Z,waterMeshes:nt,basin:ot}=Yx(d+l+6,m,f);e.add(_,z,ot);const ct=[],Y=[];for(let J=0;J<r;J++){const Jt=new Gi,Ot=i[J],ue=s[J],De=g[J],cn=h,je=Ot+l,hn=Ot-l,Ge=Math.max(8,Math.round(Math.PI/Math.asin(Math.min(.99,c/(2*hn))))),Dn=2*Ge,zn=Math.max(5,Math.round(ue*1.4)),Ji=ba(Ge,zn,cn,Math.random()<.6),Qi=ba(Ge,zn,cn,Math.random()<.6),ui=new Ws({map:Ji.texture,side:mn}),Ms=new Ws({map:Qi.texture,side:mn}),fr=He=>{const un=He*Math.PI/Ge,xn=He%2===0?je:hn;return new L(xn*Math.cos(un),De,xn*Math.sin(un))},Ss=new Pe(new Qs(hn-.05,hn-.05,ue-.1,Math.max(32,Ge)),de);Ss.position.set(0,De,0),Jt.add(Ss);for(let He=0;He<Dn;He++){const un=fr(He),xn=fr(He+1),Zn=xn.x-un.x,vn=xn.z-un.z,pi=Math.hypot(Zn,vn),$n=Math.floor(He/2),mi=$n/Ge,gi=($n+1)/Ge,ts=new Gr(pi,ue),kn=ts.attributes.uv;kn.setXY(0,mi,1),kn.setXY(1,gi,1),kn.setXY(2,mi,0),kn.setXY(3,gi,0),kn.needsUpdate=!0;const es=new Pe(ts,He%2===0?ui:Ms);es.position.set((un.x+xn.x)/2,De,(un.z+xn.z)/2),es.rotation.y=Math.atan2(-vn,Zn),Jt.add(es)}const pr=new Ws({vertexColors:!0,side:mn}),sn=Math.max(.3,hn-.1),di=He=>{const un=[],xn=[];for(let vn=0;vn<Dn;vn++){const pi=vn*Math.PI/Ge,$n=(vn+1)*Math.PI/Ge,mi=vn%2===0?je:hn,gi=(vn+1)%2===0?je:hn,ts=mi*Math.cos(pi),kn=mi*Math.sin(pi),es=gi*Math.cos($n),mr=gi*Math.sin($n),st=sn*Math.cos(pi),Ht=sn*Math.sin(pi),kt=sn*Math.cos($n),Wt=sn*Math.sin($n);un.push(ts,He,kn,es,He,mr,kt,He,Wt),un.push(ts,He,kn,kt,He,Wt,st,He,Ht);const Ze=(vn%2===0?Ji.colors:Qi.colors)[Math.floor(vn/2)]??8947848,Ee=(Ze>>16&255)/255,ys=(Ze>>8&255)/255,Ln=(Ze&255)/255;for(let Gn=0;Gn<6;Gn++)xn.push(Ee,ys,Ln)}const Zn=new ze;return Zn.setAttribute("position",new Se(un,3)),Zn.setAttribute("color",new Se(xn,3)),Zn.computeVertexNormals(),Zn},fi=di(De+ue/2),Wr=di(De-ue/2);Jt.add(new Pe(fi,pr)),Jt.add(new Pe(Wr,pr)),e.add(Jt),ct.push(Jt),Y.push({P:Ge,rows:zn,N:Dn,matA:ui,matB:Ms,capGeos:[fi,Wr]})}const $=()=>(Math.random()<.5?1:-1)*(.036+Math.random()*.072),mt=ct.map($),yt=mt.slice(),ht=J=>{const Jt=document.createElement("canvas");return Jt.width=J.width,Jt.height=J.height,Jt.getContext("2d").drawImage(J,0,0),Jt},lt=(J,Jt,Ot)=>{const ue=[];for(let De=0;De<Ot;De++){const cn=(De%2===0?J:Jt)[Math.floor(De/2)]??8947848,je=(cn>>16&255)/255,hn=(cn>>8&255)/255,Ge=(cn&255)/255;for(let Dn=0;Dn<6;Dn++)ue.push(je,hn,Ge)}return new Float32Array(ue)};let It=null,Bt=!1;const Kt=22,I=[2,3,4],at=[];I.forEach((J,Jt)=>{const Ot=i[J]+l,ue=g[J]+s[J]/2,De=Math.max(12,Math.round(2*Math.PI*Ot/3)),cn=26;for(let je=0;je<De;je++){const hn=je/De*Math.PI*2,Ge=Math.cos(hn),Dn=Math.sin(hn),zn=1.5+Math.random()*.3,Ji=7+Math.random()*2,Qi=4+Math.random()*1.5;for(let ui=0;ui<cn;ui++)at.push({ox:Ot*Ge,oy:ue,oz:Ot*Dn,cx:Ge,cz:Dn,ph:ui/cn*zn,life:zn,up:Ji,out:Qi,grp:Jt})}});const q=g[r-1]+s[r-1]/2,Mt=10;for(let J=0;J<Mt;J++){const Jt=J/Mt*Math.PI*2+Math.random()*.3,Ot=2.8+Math.random()*.8,ue=20+Math.random()*5,De=4+Math.random()*2.5,cn=84;for(let je=0;je<cn;je++)at.push({ox:0,oy:q,oz:0,cx:Math.cos(Jt),cz:Math.sin(Jt),ph:je/cn*Ot,life:Ot,up:ue,out:De,grp:3})}const rt=at.length,tt=Fx(),Et=Ox(),Ut=new Float32Array(rt*3),Re=new Float32Array(rt),ae=new Float32Array(rt),_n=new Float32Array(rt*3),yn=new Float32Array(rt),Ri=.35;for(let J=0;J<rt;J++){Ut[J*3+1]=-9999,yn[J]=(Math.random()-.5)*.5,Re[J]=.3+Math.random()*.22,ae[J]=.7+Math.random()*.3;const Jt=Math.random()*.3;_n[J*3]=.25+Jt*.5,_n[J*3+1]=.6+Jt*.35,_n[J*3+2]=.84+Jt*.16}const Ci=new ze;Ci.setAttribute("position",new Te(Ut,3)),Ci.setAttribute("aSize",new Te(Re,1)),Ci.setAttribute("aAlpha",new Te(ae,1)),Ci.setAttribute("aColor",new Te(_n,3));const Zi=qo(Et),_s=new Pa(Ci,Zi);e.add(_s);const Ie=420,xs=new Float32Array(Ie),rr=new Float32Array(Ie),ar=new Float32Array(Ie),$i=new Float32Array(Ie),or=new Float32Array(Ie),oi=new Float32Array(Ie).fill(9),Ki=new Float32Array(Ie).fill(1),li=new Float32Array(Ie*3),Vr=new Float32Array(Ie),lr=new Float32Array(Ie),vs=new Float32Array(Ie*3);for(let J=0;J<Ie;J++)li[J*3+1]=-9999,vs[J*3]=.62,vs[J*3+1]=.82,vs[J*3+2]=.95;let cr=0;const no=(J,Jt)=>{const Ot=cr;cr=(cr+1)%Ie,xs[Ot]=J,rr[Ot]=Jt;const ue=Math.random()*Math.PI*2,De=.4+Math.random()*1.1;ar[Ot]=Math.cos(ue)*De,or[Ot]=Math.sin(ue)*De,$i[Ot]=2+Math.random()*3,oi[Ot]=0,Ki[Ot]=.3+Math.random()*.3,Vr[Ot]=.22+Math.random()*.2},ci=new ze;ci.setAttribute("position",new Te(li,3)),ci.setAttribute("aSize",new Te(Vr,1)),ci.setAttribute("aAlpha",new Te(lr,1)),ci.setAttribute("aColor",new Te(vs,3));const hr=qo(Et),v=new Pa(ci,hr);e.add(v);const F=new Uint8Array(rt),W=(J,Jt)=>{const Ot=Math.sin(J*.22+Jt);return Ot>.55?1+(Ot-.55)/.45*2.6:1},k=(J,Jt)=>{const ue=((J+Jt*2.3)%7+7)%7/7;return(.2+.8*(ue<.75?ue/.75:1-(ue-.75)/.25))*W(J,Jt*1.7)},G=J=>{const Ot=(J%13+13)%13/13;let ue;if(Ot<.5)ue=.2+.8*(Ot/.5);else if(Ot<.65)ue=1-(Ot-.5)/.15;else return 0;return ue*Math.min(1.4,W(J,4))},dt=q+.2,St=3.2,ft=19,xt=Nx(new Au().load("fire-lut.png"));xt.scale.set(St,ft,St),xt.position.set(0,dt+ft/2,0);const Tt=xt.material;Tt.uniforms.magnitude.value=2.1,Tt.uniforms.lacunarity.value=2.6,Tt.uniforms.noiseScale.value.set(1,2,1,.55),e.add(xt);const Ft=J=>.55+.3*Math.sin(J*1.7)+.15*Math.sin(J*5.3),Dt=26,Ct=new Float32Array(Dt),oe=new Float32Array(Dt),Ce=new Float32Array(Dt),ye=new Float32Array(Dt),se=new Float32Array(Dt),ke=new Float32Array(Dt),bt=new Float32Array(Dt),tn=new Float32Array(Dt),jt=new Float32Array(Dt*3),ln=new Float32Array(Dt),bn=new Float32Array(Dt),en=new Float32Array(Dt*3);for(let J=0;J<Dt;J++)Ct[J]=Math.random()*Math.PI*2,oe[J]=.2+Math.random()*.9,Ce[J]=dt+1+Math.random()*4,ye[J]=3.5+Math.random()*3,se[J]=1.1+Math.random()*1.3,ke[J]=Math.random()*se[J],bt[J]=(Math.random()-.5)*3,tn[J]=.2+Math.random()*.2,jt[J*3+1]=-9999;const nn=new ze;nn.setAttribute("position",new Te(jt,3)),nn.setAttribute("aSize",new Te(ln,1)),nn.setAttribute("aAlpha",new Te(bn,1)),nn.setAttribute("aColor",new Te(en,3));const re=qo(Et);re.blending=Fa;const be=new Pa(nn,re);e.add(be);const Pn=new Nf(16747068,0,60,2);Pn.position.set(0,dt+4,0),e.add(Pn);const ie=new yu(new cc({map:tt,color:16749888,transparent:!0,opacity:0,blending:Fa,depthWrite:!1}));ie.scale.set(11,14,1),ie.position.set(0,dt+6,0),e.add(ie);let On=!0,hi=!0,Bn=1,jn=1,Dc=0,io=0,ur=0,so=0,dr=0,ro=0,Lc=!1;const ao=Lx();return{name:"Fountain",group:e,background:u,camera:[113,20,113],status:()=>{const J=Math.floor(Pt),Jt=Math.floor(Pt%1*60);return`${String(J).padStart(2,"0")}:${String(Jt).padStart(2,"0")}`},dayCount:()=>xe,recolor:()=>{Bt=!0},toggles:[{label:"fire",initial:!0,set:J=>{On=J}},{label:"water",initial:!0,set:J=>{hi=J}},{label:"sound",initial:!1,set:J=>J?ao.start():ao.stop()}],dispose:()=>{var J;ao.stop(),(J=xt.material.uniforms.fireTex.value)==null||J.dispose(),f&&_.dispose(),Z.dispose(),tt.dispose(),Et.dispose(),Vt.dispose()},update:(J,Jt,Ot)=>{const ue=Math.min(.05,Math.max(0,J-Dc));if(Dc=J,io++,Jt){(Ot==null?void 0:Ot.spinGroup)!==!1&&(e.rotation.y+=.006*ue);for(let st=0;st<ct.length;st++){const Ht=.084*ue;mt[st]+=Math.max(-Ht,Math.min(Ht,yt[st]-mt[st])),ct[st].rotation.y+=mt[st]*ue}}if(Ot){const st=Ot.renderer.domElement.height;Zi.uniforms.uScale.value=st,hr.uniforms.uScale.value=st,re.uniforms.uScale.value=st}if(Bt){Bt=!1,bc();const st=Math.random()<Wh,Ht=[],kt=[];for(const Wt of Y){const Ze=ba(Wt.P,Wt.rows,st,Math.random()<.6),Ee=ba(Wt.P,Wt.rows,st,Math.random()<.6);for(const[Ln,Gn]of[[Wt.matA,Ze],[Wt.matB,Ee]]){const ns=Ln.map.image;Ht.push({mat:Ln,from:ht(ns),to:Gn.texture.image,live:ns})}const ys=lt(Ze.colors,Ee.colors,Wt.N);for(const Ln of Wt.capGeos){const Gn=Ln.getAttribute("color");kt.push({geo:Ln,from:Float32Array.from(Gn.array),to:ys})}}It={t0:J,dur:6,items:Ht,caps:kt};for(let Wt=0;Wt<yt.length;Wt++)yt[Wt]=$()}if(It){const st=Math.min(1,(J-It.t0)/It.dur);if(io%3===0||st>=1){const Ht=st*st*(3-2*st);for(const kt of It.items){const Wt=kt.live.getContext("2d");Wt.globalAlpha=1,Wt.drawImage(kt.from,0,0),Wt.globalAlpha=Ht,Wt.drawImage(kt.to,0,0),Wt.globalAlpha=1,kt.mat.map.needsUpdate=!0}for(const kt of It.caps){const Wt=kt.geo.getAttribute("color"),Ze=Wt.array;for(let Ee=0;Ee<Ze.length;Ee++)Ze[Ee]=kt.from[Ee]+(kt.to[Ee]-kt.from[Ee])*Ht;Wt.needsUpdate=!0}}st>=1&&(It=null)}const De=(Ot==null?void 0:Ot.skyTime)??J,cn=De/T*Math.PI*2+1.1,je=cn-Math.PI/2,hn=-Math.sin(je),Ge=Math.cos(b)*Math.cos(je),Dn=Math.sin(b)*Math.cos(je),zn=Ge,Ji=hn*P,Qi=Ge*P,ui=Dn*P;x.position.set(Ji,Qi,ui);const Ms=je-D,fr=-Math.sin(Ms),Ss=Math.cos(b)*Math.cos(Ms),pr=Math.sin(b)*Math.cos(Ms);A.position.set(fr*P,Ss*P,pr*P);const sn=Math.min(1,Math.max(0,(zn+.42)/.46)),di=1-sn,fi=Math.max(0,1-Math.abs(zn)/.38),Wr=x.material;x.rotation.y=De*.1,A.rotation.y=-De*.06;const He=Math.max(0,Math.min(1,(Ss*P+6)/18));Wr.color.lerpColors(Rt,et,Math.min(1,Math.max(0,zn/.45)));const un=1+.1*fi;x.scale.set(un,un,un),M.position.set(Ji,Math.max(Qi,8),ui),M.intensity=X*sn,M.color.lerpColors(ut,it,Math.min(1,Math.max(0,zn/.42))),Ot&&Vt.update(Ot.renderer,M,sn,fi,x.getWorldPosition(C).normalize(),ue),y.position.set(fr*P,Math.max(Ss*P,12),pr*P),y.intensity=.2*sn+U*di*He*(.35+.65*w);const xn=.4+.6*sn+.32*di*He*w,Zn=Zi.uniforms.uTint.value;Zn.setRGB(xn*(1-.14*di),xn*(1-.06*di),xn),hr.uniforms.uTint.value.copy(Zn),y.color.lerpColors(O,j,sn),p.intensity=1.6+.6*sn,p.color.lerpColors(At,vt,sn).lerp(K,fi*.4),p.groundColor.lerpColors(Qt,zt,sn),Lt.lerpColors(B,H,sn).lerp(Q,fi*.6),Ot==null||Ot.renderer.setClearColor(Lt),Le.lerpColors(_e,he,sn).lerp(qt,fi*.45),Oe.uHorizon.value.copy(Lt),Oe.uZenith.value.copy(Le),Oe.uNight.value=di,Oe.uTime.value=J,Oe.uSunDir.value.set(hn,Ge,Dn),Oe.uGlow.value=fi,Pt=(((cn-Math.PI/2)/(Math.PI*2)*24+12)%24+24)%24;const vn=Pt<.6||Pt>23.4;if(vn&&!Yt&&xe++,Yt=vn,_.material.uniforms.uTime.value=J,Ot&&!f&&io%2===0){for(const st of nt)st.visible=!1;z.update(Ot.renderer,Ot.scene);for(const st of nt)st.visible=!0}const pi=.35+.35*Math.sin(J*.11+2.1)+.2*Math.sin(J*.031),$n=J*.05,mi=Math.cos($n)*pi,gi=Math.sin($n)*pi;Lc||(so=J+35+Math.random()*35,ro=J+28+Math.random()*32,Lc=!0),ur?J>=ur&&(ur=0,so=J+35+Math.random()*35):J>=so&&(ur=J+5+Math.random()*5),dr?J>=dr&&(dr=0,ro=J+28+Math.random()*32):J>=ro&&(dr=J+4+Math.random()*4);const ts=1.3,kn=(st,Ht)=>{const kt=ue/ts,Wt=Ht?1:0;return st<Wt?Math.min(Wt,st+kt):Math.max(Wt,st-kt)};if(jn=kn(jn,hi&&!ur),Bn=kn(Bn,On&&!dr),f){const st=_.material.uniforms;st.uNight.value=di,st.uSky.value.copy(Lt);const Ht=d+l+6;for(let kt=0;kt<I.length;kt++){const Wt=I[kt],Ze=Math.min(1,k(J,kt)),Ee=8*Ze*jn,ys=4.75*(1-.7*Ze)*jn,Ln=g[Wt]+s[Wt]/2-m,Gn=(Ee+Math.sqrt(Ee*Ee+2*Kt*Ln))/Kt,ns=ys/Ri*(1-Math.exp(-Ri*Gn));st.uImpactR.value.setComponent(kt,Math.min(.96,(i[Wt]+l+ns)/Ht)),st.uImpactA.value.setComponent(kt,.12*Ze*jn)}}_s.visible=jn>.001;const es=jn>.25;if(_s.visible){Zi.uniforms.uOpacity.value=.95*Math.min(1,jn*1.6);for(let st=0;st<rt;st++){const Ht=at[st],kt=(J+Ht.ph)%Ht.life,Wt=Ht.grp===3?G(J-kt):k(J-kt,Ht.grp);if(Wt<.04){Ut[st*3+1]=-9999,F[st]=0;continue}const Ze=Wt>1?1:Wt,Ee=Ht.up*Wt*jn,Ln=Ht.out*(1-.7*Ze)*jn/Ri*(1-Math.exp(-Ri*kt)),Gn=yn[st]*kt*kt,ns=.35*kt*kt,Ic=Ht.oy+Ee*kt-.5*Kt*kt*kt,Uc=Ht.ox+Ht.cx*Ln-Ht.cz*Gn+mi*ns,Nc=Ht.oz+Ht.cz*Ln+Ht.cx*Gn+gi*ns;if(Ic<m-.3){F[st]&&es&&Math.random()<.3&&no(Uc,Nc),F[st]=0,Ut[st*3+1]=-9999;continue}Ut[st*3]=Uc,Ut[st*3+1]=Ic,Ut[st*3+2]=Nc,F[st]=1}Ci.attributes.position.needsUpdate=!0}let mr=!1;for(let st=0;st<Ie;st++){oi[st]<Ki[st]&&(oi[st]+=ue);const Ht=oi[st];if(Ht>=Ki[st]){li[st*3+1]=-9999,lr[st]=0;continue}mr=!0,li[st*3]=xs[st]+ar[st]*Ht,li[st*3+1]=m+.1+$i[st]*Ht-.5*Kt*Ht*Ht,li[st*3+2]=rr[st]+or[st]*Ht,lr[st]=.85*(1-Ht/Ki[st])}if(v.visible=mr,mr&&(ci.attributes.position.needsUpdate=!0,ci.attributes.aAlpha.needsUpdate=!0),xt.visible=Bn>.001,xt.visible){const st=.85+.3*(Ft(J)-.55);xt.scale.set(St,ft*st,St),xt.position.y=dt+ft*st/2,xt.rotation.x=gi*.07,xt.rotation.z=-mi*.07,xt.updateFire(J,Math.min(1,Bn*1.5))}if(ie.visible=xt.visible,ie.visible&&(ie.material.opacity=.12*Bn*(.7+.6*Ft(J))),Pn.intensity=Bn*(26+30*(Ft(J)-.55)),be.visible=Bn>.01,be.visible){re.uniforms.uOpacity.value=.9*Bn;for(let st=0;st<Dt;st++){const Ht=(J+ke[st])%se[st],kt=Ht/se[st],Wt=Ct[st]+bt[st]*Ht,Ze=oe[st]+.6*kt;if(jt[st*3]=Math.cos(Wt)*Ze+mi*1.6*Ht,jt[st*3+1]=Ce[st]+ye[st]*Ht,jt[st*3+2]=Math.sin(Wt)*Ze+gi*1.6*Ht,kt<.45){const Ee=kt/.45;en[st*3]=1-.02*Ee,en[st*3+1]=.9-.42*Ee,en[st*3+2]=.35-.22*Ee}else{const Ee=(kt-.45)/.55;en[st*3]=.98-.43*Ee,en[st*3+1]=.48+.07*Ee,en[st*3+2]=.13+.42*Ee}bn[st]=Math.min(1,kt/.12)*Math.max(0,1-Math.max(0,(kt-.55)/.45)),ln[st]=tn[st]*(1-.4*kt)}nn.attributes.position.needsUpdate=!0,nn.attributes.aColor.needsUpdate=!0,nn.attributes.aAlpha.needsUpdate=!0,nn.attributes.aSize.needsUpdate=!0}}}}const Xh="Yaacov Agam",Yh="Fire and Water",qh="1928–2026",jx="https://fonts.googleapis.com/css2?family=Anton&family=Bebas+Neue&family=Cinzel:wght@400;500&family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300&family=Fraunces:ital,wght@0,300;0,400;1,300&family=Italiana&family=Space+Grotesk:wght@300;400&family=Space+Mono&family=Syne:wght@400;500&display=swap",jh={serif:"font-family:'Cormorant Garamond',Georgia,'Times New Roman',serif;",fraunces:"font-family:'Fraunces',Georgia,serif;",italiana:"font-family:'Italiana',Georgia,serif;",cinzel:"font-family:'Cinzel',Georgia,serif;",grotesk:"font-family:'Space Grotesk','Helvetica Neue',Arial,sans-serif;",syne:"font-family:'Syne','Helvetica Neue',Arial,sans-serif;",mono:"font-family:'Space Mono',ui-monospace,Menlo,monospace;",poster:"font-family:'Anton',Impact,'Arial Narrow',sans-serif;font-weight:400;",bebas:"font-family:'Bebas Neue',Impact,'Arial Narrow',sans-serif;font-weight:400;"},Ea=["top","topbottom","corners","grotesk","mono","poster","side"];function Zx(n,t,e,i){const s=document.createElement("link");s.rel="stylesheet",s.href=jx,document.head.appendChild(s);const r=e.has("design")||e.get("text")==="pick",a=e.get("text")||"top",o={variant:Ea.includes(a)?a:a==="cycle"&&!r?"cycle":"top",font:e.get("tf")||"auto",scale:Number(e.get("ts"))||1,track:e.get("tt")!==null&&!isNaN(Number(e.get("tt")))?Number(e.get("tt")):1,alpha:Number(e.get("to"))||.6,weight:e.get("tw")||"300",tcase:e.get("tc")||"none",tint:e.get("th")||"white",blend:e.get("tb")||"none",shadow:e.get("td")!==null&&!isNaN(Number(e.get("td")))?Number(e.get("td")):1,italic:e.get("ti")||"0",rule:e.get("tr")||"none",name:e.get("name")||Xh,work:e.get("work")||Yh,years:e.get("years")||qh},l=t?"max(3%, 60px)":"3%",c=t?"8%":"2.5%",h=(j,O)=>`font-size:max(${Math.round(j*o.scale)}px,${(O*o.scale).toFixed(2)}vh);`,u=j=>`letter-spacing:${(j*o.track).toFixed(3)}em;`,d=j=>`text-indent:${(j*o.track).toFixed(3)}em;`,f=j=>o.font!=="auto"&&jh[o.font]||jh[j],g={white:"255,255,255",cream:"246,240,226",gold:"226,196,148",ink:"26,26,28"},S={none:"",lower:"text-transform:lowercase;",upper:"text-transform:uppercase;",smallcaps:"font-variant:small-caps;"},m=(j=1)=>`position:absolute;pointer-events:none;user-select:none;font-weight:${o.weight};line-height:1.25;color:rgba(${g[o.tint]??g.white},${(o.alpha*j).toFixed(3)});`+(o.italic==="1"?"font-style:italic;":"")+(S[o.tcase]??"")+(o.blend!=="none"?`mix-blend-mode:${o.blend};`:"")+(o.shadow>0?`text-shadow:0 1px 18px rgba(0,0,0,${(.6*o.shadow).toFixed(2)}),0 0 4px rgba(0,0,0,${(.35*o.shadow).toFixed(2)});`:""),p=(j,O,K=1)=>{const et=document.createElement("div");return et.textContent=j,et.style.cssText=m(K)+O,et},M=(j,O)=>{const K=p("",j);for(const et of O)et.style.position="static";return K.append(...O),[K]},y=(j=!1)=>{if(o.rule!=="rule")return[];const O=document.createElement("div");return O.style.cssText=`width:2.8em;height:1px;background:rgba(${g[o.tint]??g.white},${(o.alpha*.75).toFixed(3)});margin:.6em ${j?"0":"auto"} .5em;`,[O]},T=()=>{const{name:j,work:O,years:K}=o,[et,Rt=""]=K.split(/[–—-]/);return{top:()=>M("top:3.4%;left:0;right:0;text-align:center;",[p(j,f("serif")+u(.1)+h(30,5.4)),p(O,f("serif")+"font-style:italic;"+u(.14)+h(17,2.9),.9),...y(),p(K,f("serif")+u(.3)+h(14,2.3)+"margin-top:.25em;")]),topbottom:()=>[...M("top:3.4%;left:0;right:0;text-align:center;",[p(j,f("serif")+u(.1)+h(26,4.6)),...y(),p(O,f("serif")+"font-style:italic;"+u(.14)+h(16,2.6),.9)]),p(K,f("serif")+"bottom:3.4%;left:0;right:0;text-align:center;"+u(.3)+h(15,2.6))],corners:()=>[p(j,f("serif")+`top:${l};left:2.4%;`+u(.1)+h(22,3.8)),p(O,f("serif")+`top:${l};right:2.4%;font-style:italic;`+u(.12)+h(20,3.4)),p(et,f("serif")+"bottom:9%;left:2.4%;"+u(.3)+h(16,2.7)),p(Rt||K,f("serif")+"bottom:9%;right:2.4%;"+u(.3)+h(16,2.7))],grotesk:()=>[p(j,f("grotesk")+"top:4%;left:0;right:0;text-align:center;"+u(.45)+d(.45)+h(15,2.5)),p(`${O} · ${K}`,f("grotesk")+"bottom:4%;left:0;right:0;text-align:center;"+u(.35)+d(.35)+h(12,1.9),.8)],mono:()=>M("bottom:3.6%;left:0;right:0;text-align:center;",[p(j,f("mono")+u(.08)+h(13,2.1)),p(O,f("mono")+u(.14)+h(12,1.9),.85),...y(),p(K,f("mono")+u(.25)+h(11,1.7)+"margin-top:.2em;",.75)]),poster:()=>M(`bottom:${c};left:3%;`,[p(j,f("poster")+u(.03)+"line-height:1;"+h(34,7),.85),...y(!0),p(`${O} · ${K}`,f("grotesk")+u(.3)+h(13,2)+"margin-top:.4em;",.85)]),side:()=>[p(`${j} · ${O}`,f("grotesk")+"left:2%;top:50%;transform:translateY(-50%) rotate(180deg);writing-mode:vertical-rl;white-space:nowrap;"+u(.4)+h(13,2.1)),p(K,f("grotesk")+"right:2%;top:50%;transform:translateY(-50%) rotate(180deg);writing-mode:vertical-rl;white-space:nowrap;"+u(.4)+h(12,1.9),.85)]}},P=j=>{const O=document.createElement("div");O.style.cssText=`position:${t?"fixed":"absolute"};inset:0;pointer-events:none;z-index:${t?9999:3};transition:opacity 1200ms ease;`;for(const K of T()[j]())O.appendChild(K);return n.appendChild(O),O};let b=[];const R=()=>{for(const j of b)j.remove();if(o.variant==="cycle"){b=Ea.map(P),b.forEach((O,K)=>O.style.opacity=K===0?"1":"0");let j=0;setInterval(()=>{b[j].style.opacity="0",j=(j+1)%b.length,b[j].style.opacity="1"},18e3)}else b=[P(o.variant)]};if(R(),!r)return;const x=()=>{const j=new URLSearchParams(location.search),O=(K,et,Rt)=>et===Rt?j.delete(K):j.set(K,et);j.set("text",o.variant),O("tf",o.font,"auto"),O("ts",String(o.scale),"1"),O("tt",String(o.track),"1"),O("to",String(o.alpha),"0.6"),O("tw",o.weight,"300"),O("tc",o.tcase,"none"),O("th",o.tint,"white"),O("tb",o.blend,"none"),O("td",String(o.shadow),"1"),O("ti",o.italic,"0"),O("tr",o.rule,"none"),O("name",o.name,Xh),O("work",o.work,Yh),O("years",o.years,qh),history.replaceState(null,"","?"+j.toString())};x();const A=document.createElement("style");A.textContent=`
